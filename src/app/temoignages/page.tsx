    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative overflow-hidden bg-navy">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 text-center md:py-28">
          ...
          <h1 className="animate-fade-up delay-1 mx-auto mt-6 max-w-3xl font-display text-4xl font-bold leading-[1.1] text-white md:text-6xl">
            La parole à{" "}
            <span className="accent-underline text-accent">ceux qui osent</span>
          </h1>
          <p className="animate-fade-up delay-2 mx-auto mt-6 max-w-xl text-lg leading-relaxed text-white/70">
            Pas de langue de bois. Juste des dirigeants qui racontent ce qui a
            réellement changé.
          </p>

          {/* Stats */}
          <div className="animate-fade-up delay-3 mx-auto mt-12 grid max-w-2xl grid-cols-3 gap-4">
